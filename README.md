...
3. Optionnel : ajouter `mapMinZoom`, `mapMaxZoom`, `mapMaxBounds` pour verrouiller la navigation, et `atmoMicroAllowedSiteIds` pour filtrer les microcapteurs ;
4. Ajuster `getConfigForDomain` si necessaire pour que le(s) hostname(s) de cette instance y soient correctement resolus ;
5. Verifier le rendu du rail, du favicon, du centrage de carte, et le panneau "A propos".
