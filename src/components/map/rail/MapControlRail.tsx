 ...
 * Leaflet ancrés à gauche, la légende et la TimeBar pour s'écarter — sans
...
export const MapControlRail: React.FC<MapControlRailProps> = ({
  ...
  // rail est en bas : on publie sa hauteur pour que TimeBar, légende et
  // `.leaflet-bottom` s'élèvent au-dessus ; en vertical, seul le décalage
  // latéral compte.
  useEffect(() => {
